...
function getGender(){
 ...
 if (dayOfWeekNumber == 0){
  ...
  if (myGenderValue == "male" && monthValid && dayValid) {
    ...
    document.getElementById('display-name').innerHTML = "Here is your Akan name: ";
    document.getElementById('result').style.fontSize = "18px";
    document.querySelector('h1').innerHTML= "Hello" + " " + maleAkanNames[index];
    return false;
    ...
    document.getElementById('display-name').innerHTML = "Here is your Akan name: ";
    document.getElementById('result').style.fontSize = "18px";
    document.querySelector('h1').innerHTML = "Hello" + " " + femaleAkanNames[index];
    return false;
  } else {
